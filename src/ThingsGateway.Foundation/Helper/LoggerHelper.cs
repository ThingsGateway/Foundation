...
public static class LoggerHelper
{
    ...
    {
        return PathHelper.CombinePathReplace(GetDebugLogBasePath(), channelId.ToString());
    }
    ...
    {
        return PathHelper.CombinePathReplace(GetDebugLogBasePath(), channelId.SanitizeFileName());
    }
    ...
    {
        return PathHelper.CombinePathReplace(GetChannelLogBasePath(), channelId.ToString());
    }
    /// <summary>
    /// 获取日志路径
    /// </summary>
    ...
    {
        return PathHelper.CombinePathReplace(GetChannelLogBasePath(), channelId.SanitizeFileName());
    }
    ...
    {
        return PathHelper.CombinePathReplace(GetDeviceLogBasePath(), DeviceId.ToString());
    }
    /// <summary>
    /// 获取日志路径
    /// </summary>
    ...
    {
        return PathHelper.CombinePathReplace(GetDeviceLogBasePath(), DeviceId.SanitizeFileName());
    }
