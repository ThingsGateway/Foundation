...
public static class DisposableHelper
{
    ...
    public static async Task<OperResult> SafeDisposeAsync(this IAsyncDisposable dis)
    {
        if (dis == default)
        {
    ...
    public static async Task<OperResult> SafeCancelAsync(this CancellationTokenSource tokenSource)
    {
