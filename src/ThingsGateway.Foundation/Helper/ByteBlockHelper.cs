...
# if NET6_0_OR_GREATER
    ...
    {
        return byteBlock.TotalSequence.Slice(offset, length).ToHexString(splite);
    }
    public static string ToHexString(this ReadOnlySequence<byte> byteBlock, char splite = default)
    {
        return ArrayHelper.ToHexString(byteBlock, splite);
    }
    ...
    {
        return byteBlock.TotalSequence.ToHexString(splite);
