...
public static class OperResultExtension
{
    ...
    public static OperResult<object> GetOperResult(this IOperResult data)
    {
        ...
        {
            var contentProperty = interfaceType.GetProperty(nameof(IOperResult<>.Content));
    ...
    /// 转换对应类型
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Performance", "CA1863:使用 \"CompositeFormat\"", Justification = "<挂起>")]
