...
#pragma warning restore CA2000 // 丢失范围之前释放对象
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        static async PooledValueTask<DeviceMessage> GetResponsedDataAsync(DeviceBase @this, ISendMessage command, IClientChannel clientChannel, int timeout, CancellationToken cancellationToken)
        {
