...
public class OtherChannel : SetupConfigObject, IClientChannel
{
    ...
    {
        if (ReadOnlyDataHandlingAdapter is IDeviceDataHandleAdapter handleAdapter && log != null)
        {
    ...
    protected void SetAdapter(SingleStreamDataHandlingAdapter adapter)
    {
        ...
        ArgumentNullExceptionEx.ThrowIfNull(adapter, nameof(adapter));
    ...
    public Task SendAsync(IRequestInfo requestInfo, CancellationToken cancellationToken)
    {
        ...
        {
            throw new NotSupportedException("The current adapter is empty or does not support object sending.");
        }
