...
public static class ChannelOptionsExtensions
{
    ...
    {
        ArgumentNullExceptionEx.ThrowIfNull(clientChannel, nameof(clientChannel));
        ArgumentNullExceptionEx.ThrowIfNull(e, nameof(e));
        ArgumentNullExceptionEx.ThrowIfNull(funcs, nameof(funcs));
    ...
    public static IChannel GetChannel(this TouchSocketConfig config, IChannelOptions channelOptions)
    {
        ...
        ArgumentNullExceptionEx.ThrowIfNull(channelType, nameof(channelType));
    ...
    private static TcpClientChannel GetTcpClient(this TouchSocketConfig config, IChannelOptions channelOptions)
    {
        ...
        ArgumentNullExceptionEx.ThrowIfNull(remoteUrl, nameof(remoteUrl));
        channelOptions.Config = config;
