...
public class DeviceMessage : OperResultClass<ReadOnlyMemory<byte>>, IResultMessage, IWaitHandle
{
    ...
    /// <inheritdoc />
    public DeviceMessage(IOperResult operResult) : base(operResult)
    {
    }
    /// <inheritdoc />
    public DeviceMessage(OperResult operResult) : base(operResult)
    {
    }
    /// <inheritdoc />
    public DeviceMessage(Exception ex) : base(ex)
    {
    }
