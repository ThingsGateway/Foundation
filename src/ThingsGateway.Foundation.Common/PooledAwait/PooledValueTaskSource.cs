...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    /// </summary>
    public readonly struct PooledValueTaskSource : IEquatable<PooledValueTaskSource>
    {
        ...
        public bool Equals(PooledValueTaskSource pvt) => _source == pvt._source && _token == pvt._token;
        ...
        {
            if (!TrySetCanceled()) PooledAwaitThrowHelper.ThrowInvalidOperationException();
        }
        ...
        public static bool operator ==(PooledValueTaskSource left, PooledValueTaskSource right)
        {
