...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    /// </summary>
    public readonly struct LazyTaskCompletionSource : IDisposable, IEquatable<LazyTaskCompletionSource>
    {
        ...
        public bool Equals(LazyTaskCompletionSource ltcs) => _state == ltcs._state && _token == ltcs._token;
        ...
        /// </summary>
        public Task Task => _state?.GetTask(_token) ?? PooledAwaitThrowHelper.ThrowInvalidOperationException<Task>();
        ...
        {
            if (!TrySetResult()) PooledAwaitThrowHelper.ThrowInvalidOperationException();
        }
        ...
        public static bool operator ==(LazyTaskCompletionSource left, LazyTaskCompletionSource right)
        {
