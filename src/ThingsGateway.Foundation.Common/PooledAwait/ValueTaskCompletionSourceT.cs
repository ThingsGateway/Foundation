...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct ValueTaskCompletionSource<T> : IEquatable<ValueTaskCompletionSource<T>>
    {
        ...
        public bool Equals(ValueTaskCompletionSource<T> other) => _state == other._state;
        ...
        {
            if (!TrySetResult(value)) PooledAwaitThrowHelper.ThrowInvalidOperationException();
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void SpinUntilCompleted(Task<T> task)
        {
        ...
        public static bool operator ==(ValueTaskCompletionSource<T> left, ValueTaskCompletionSource<T> right)
        {
