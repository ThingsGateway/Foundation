...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    /// </summary>
    public readonly struct PooledValueTaskSource<T> : IEquatable<PooledValueTaskSource<T>>
    {
        ...
        public bool Equals(PooledValueTaskSource<T> pvt) => _token == pvt._token &&
            (_source != null ? _source == pvt._source : (pvt._source == null && EqualityComparer<T>.Default.Equals(_value, pvt._value)));
        ...
        public static bool operator ==(PooledValueTaskSource<T> left, PooledValueTaskSource<T> right)
        {
