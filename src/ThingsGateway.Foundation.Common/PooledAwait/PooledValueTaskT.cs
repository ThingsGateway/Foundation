...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct PooledValueTask<T> : IEquatable<PooledValueTask<T>>
    {
        ...
        public bool Equals(PooledValueTask<T> pvt) => _source == pvt._source && _token == pvt._token;
...
#pragma warning restore CA2012 // 正确使用 ValueTask
        ...
        public static bool operator ==(PooledValueTask<T> left, PooledValueTask<T> right)
        {
