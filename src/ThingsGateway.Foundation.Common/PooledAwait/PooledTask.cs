...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct PooledTask : IEquatable<PooledTask>
    {
        ...
        public static bool operator ==(PooledTask left, PooledTask right)
        {
