...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct ConfiguredYieldAwaitable : IEquatable<ConfiguredYieldAwaitable>
    {
        ...
        public bool Equals(ConfiguredYieldAwaitable other) => other._continueOnCapturedContext == _continueOnCapturedContext;
        ...
        /// <summary>Provides an awaitable context for switching into a target environment.</summary>
        public readonly struct ConfiguredYieldAwaiter : ICriticalNotifyCompletion, INotifyCompletion, IEquatable<ConfiguredYieldAwaitable>
        {
            /// <summary><see cref="Object.Equals(Object)"/></summary>
            ...
            public static bool operator ==(ConfiguredYieldAwaiter left, ConfiguredYieldAwaiter right)
            {
        ...
        public static bool operator ==(ConfiguredYieldAwaitable left, ConfiguredYieldAwaitable right)
        {
            return left.Equals(right);
        }
