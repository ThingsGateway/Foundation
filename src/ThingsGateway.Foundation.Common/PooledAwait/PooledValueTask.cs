...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct PooledValueTask : IEquatable<PooledValueTask>
    {
        ...
        public bool Equals(PooledValueTask pvt) => _source == pvt._source && _token == pvt._token;
...
#pragma warning restore CA2012 // 正确使用 ValueTask
        ...
        public static bool operator ==(PooledValueTask left, PooledValueTask right)
        {
