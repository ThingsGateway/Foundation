...
namespace ThingsGateway.Foundation.Common.PooledAwait
{
    ...
    public readonly struct PooledTask<T> : IEquatable<PooledTask<T>>
    {
        ...
        public bool Equals(PooledTask<T> pt) => _task == pt._task;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Task<T> AsTask() => _task ?? PooledAwaitThrowHelper.ThrowInvalidOperationException<Task<T>>();
        ...
        public static bool operator ==(PooledTask<T> left, PooledTask<T> right)
        {
