...
namespace ThingsGateway.Foundation.Common.PooledAwait.MethodBuilders
{
    ...
    public struct PooledTaskMethodBuilder<T> : IEquatable<PooledTaskMethodBuilder<T>>
    {
        public override bool Equals(object? obj) => PooledAwaitThrowHelper.ThrowNotSupportedException<bool>();
        public bool Equals(PooledTaskMethodBuilder<T> obj) => PooledAwaitThrowHelper.ThrowNotSupportedException<bool>();
        ...
        public static bool operator ==(PooledTaskMethodBuilder<T> left, PooledTaskMethodBuilder<T> right)
        {
