...
public class Cron
{
    ...
    public IReadOnlyCollection<Int32>? Seconds { get; set; }

    /// <summary>分钟集合</summary>
    public IReadOnlyCollection<Int32>? Minutes { get; private set; }

    /// <summary>小时集合</summary>
    public IReadOnlyCollection<Int32>? Hours { get; set; }

    /// <summary>日期集合</summary>
    public IReadOnlyCollection<Int32>? DaysOfMonth { get; set; }

    /// <summary>月份集合</summary>
    public IReadOnlyCollection<Int32>? Months { get; set; }
    ...
    private static Boolean TryParse(String value, Int32 start, Int32 max, out Int32[] vs)
    {
        ...
        using var rs = new ValueListBuilder<Int32>();
        vs = Array.Empty<int>();
