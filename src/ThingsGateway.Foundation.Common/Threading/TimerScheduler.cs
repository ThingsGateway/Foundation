...
public class TimerScheduler : IDisposable
{
    ...
    /// <exception cref="ArgumentNullException"><paramref name="timer"/> is <c>null</c>.</exception>
    /// <exception cref="ObjectDisposedException"></exception>
    public void Add(TimerX timer)
    {
        ArgumentNullExceptionEx.ThrowIfNull(timer, nameof(timer));

        ObjectDisposedExceptionEx.ThrowIf(_disposing, nameof(TimerScheduler));
