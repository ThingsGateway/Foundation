...
namespace ThingsGateway.Foundation.Common.Caching.Buffers;
...
public ref struct BufferedReader
{
    ...
    {
        ArgumentOutOfRangeExceptionEx.ThrowIfNegative(count);
    ...
    public ReadOnlySpan<Byte> GetSpan(Int32 sizeHint = 0)
    {
        if (sizeHint > FreeCapacity)
            ThrowHelper.ThrowArgumentOutOfRangeException(sizeHint, nameof(sizeHint));
