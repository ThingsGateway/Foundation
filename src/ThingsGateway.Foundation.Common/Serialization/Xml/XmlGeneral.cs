...
public class XmlGeneral : XmlHandlerBase
{
    ...
    public override Boolean TryRead(Type type, ref Object? value)
    {
        ...
        // 读取异构Xml时可能报错
        var v = (reader.NodeType == XmlNodeType.Element ? reader.ReadElementContentAsString() : reader.ReadContentAsString()) + string.Empty;
        ...
        {
            value = reader.ReadContentAsString().ChangeTypeEx(type);
            return true;
        }
#endif
