...
namespace System.Collections.Concurrent
{
    ...
    public class NonBlockingDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
            ...
            : this(comparer)
        {
            ...
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(collection));
            }
        ...
        private void InitializeFromCollection(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
            foreach (KeyValuePair<TKey, TValue> pair in collection)
            {
                if (pair.Key is null)
                {
                    ThrowHelpers.ThrowKeyNullException();
                }
        ...
        public NonBlockingDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey>? comparer)
        {
            ...
            {
                ThrowHelper.ThrowArgumentOutOfRangeException(concurrencyLevel, nameof(concurrencyLevel));
            }
            ArgumentOutOfRangeExceptionEx.ThrowIfNegative(capacity, nameof(capacity));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference (Nothing in Visual Basic).</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP || NETCOREAPP
        ...
        public bool TryRemove(KeyValuePair<TKey, TValue> item)
        {
            if (item.Key is null)
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(item));
            }
        ...
        private void CopyToPairs(KeyValuePair<TKey, TValue>[] array, int index)
        {
            if (array is null)
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(array));
            }
        ...
        public TValue GetOrAdd(TKey key, Func<TKey, TValue> valueFactory)
        {
            ...
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(valueFactory));
            }
            ...
            TKey key, Func<TKey, TArg, TValue> addValueFactory, Func<TKey, TValue, TArg, TValue> updateValueFactory, TArg factoryArgument)
        {
            ...
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(addValueFactory));
            }

            if (updateValueFactory is null)
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(updateValueFactory));
            }
        ...
        private static void ThrowIfInvalidObjectValue(object? value)
        {
            if (value != null)
            {
                if (!(value is TValue))
                {
                    ThrowHelpers.ThrowValueNullException();
                }
            }
    ...
    internal sealed class IDictionaryDebugView<TKey, TValue> where TKey : notnull
    {
        ...
        public IDictionaryDebugView(IDictionary<TKey, TValue> dictionary)
        {
            ...
            {
                ThrowHelpers.ThrowArgumentNullException(nameof(dictionary));
            }
