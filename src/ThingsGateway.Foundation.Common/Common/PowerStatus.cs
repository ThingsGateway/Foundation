...
#else
    [LibraryImport("kernel32.dll", SetLastError = false, EntryPoint = "GetSystemPowerStatus")]
    [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
    [return: MarshalAs(UnmanagedType.Bool)]
    private static partial bool GetSystemPowerStatus(ref SYSTEM_POWER_STATUS systemPowerStatus);
#endif
