...
namespace Yitter.IdGenerator
{
    ...
    /// </summary>
    internal sealed class SnowWorkerM3 : SnowWorkerM1
    {
        /// <summary>
        /// 数据中心ID（默认0）
        /// </summary>
        private readonly uint DataCenterId = 0;

        /// <summary>
        /// 数据中心ID长度（默认0）
        /// </summary>
        private readonly byte DataCenterIdBitLength = 0;

        /// <summary>
        /// 时间戳类型（0-毫秒，1-秒），默认0
        /// </summary>
        private readonly byte TimestampType = 0;
