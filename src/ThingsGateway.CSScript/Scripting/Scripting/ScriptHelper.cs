...
namespace Westwind.Scripting
{
    ...
    public class ScriptHelper
    {
        ...
        public async Task<RawString> RenderPartialAsync(string scriptPath, object model = null)
        {
            ...
            var script = await ReadFileAsync(scriptPath).ConfigureAwait(false);
            string result = await _parser.ExecuteScriptAsync(script, model).ConfigureAwait(false);
            if (_parser.Error)
            {
        ...
        /// </summary>
        /// <param name="script">text or script to render</param>
        /// <param name="model">optional model to pass in</param>
        /// <returns></returns>
        ...
        /// <param name="model">optional model to pass in</param>
        /// <returns></returns>
        public Task<string> RenderScriptAsync(string script, object model = null)
        {
            return _parser.ExecuteScriptAsync(script, model);
        }
